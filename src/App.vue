  ...
  <div id="app" class="main">
    ...
    <div class="about-contact">
      <div class="about">
        <h2>About Me</h2>
        <p>
          Debbie enjoys programming, exersicing and traveling.
          he has recently decided to embark on a more thought provoking
          career path and is looking forward to challanging herself daily.
        </p>
      </div>
      <div class="contact">
        <h2>Contact</h2>
